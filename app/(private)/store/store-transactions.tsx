...
export default function TransactionsScreen() {
  ...
  const storeId = useMemo(() => params.storeId, [params.storeId]);

  const { getVendorById } = useVendors();

  const { data: vendor, isLoading: isLoadingStore } = useQuery({
  ...
  const totalIsLoading = isLoading || isLoadingStore;
