...
export default function HomeScreen() {
  ...
  const handleCardPress = (cardType: string) => {
    ...
    switch (cardType) {
      case "staff":
        router.push("/(private)/home/my-staff" as any);
        break;
      case "store":
        router.push("/(private)/store" as any);
        break;
      case "orders":
        router.push("/(private)/orders" as any);
        break;
      case "transactions":
      ...
      case "wallet":
        ...
        break;
      case "stores":
        router.push("/(private)/home/my-stores" as any);
        break;
      case "completed-orders":
        router.push("/(private)/home/completed-orders" as any);
        break;
      case "products":
        router.push("/(private)/home/products" as any);
        break;
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.rightSection}>
            <NotificationBell from="/(private)/home" />
          </View>
        </View>
      </View>
