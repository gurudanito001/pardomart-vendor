...
export default function HomeScreen() {
  const handleSetupStore = () => {
    router.push("/(tabs)/home/setting-up-store" as any);
  };
  ...
  const handleCardPress = (cardType: string) => {
    ...
    switch (cardType) {
      case "shoppers":
        router.push("/(tabs)/home/my-shoppers" as any);
        break;
      case "store":
      ...
      case "orders":
        ...
        break;
      case "transactions":
        router.push("/(tabs)/home/transactions" as any);
        break;
      case "customers":
        router.push("/(tabs)/home/customers" as any);
        break;
      case "wallet":
        router.push("/(tabs)/home/earnings-wallet" as any);
        break;
      case "stores":
        router.push("/(tabs)/home/my-stores" as any);
        break;
      case "completed-orders":
        router.push("/(tabs)/home/completed-orders" as any);
        break;
